...
const validationDictionary: ValidationRules = {
  releaseItem: {
    noProjectId: {
      ...
      reference:
        "TODO: Add your company-specific documentation link for release item conventions",
    },
    missingAreaLabel: {
      label: "At least one `area:` prefix label is needed on the Release Item",
      reference:
        "TODO: Add your company-specific documentation link for labeling conventions",
    },
    missingTeamLabel: {
    ...
    missingTeamTranslation: (team: string) => ({
      ...
      reference:
        "TODO: Add your company-specific documentation link for team translations",
    }),
    missingEstimate: {
      label: "The `Story point estimate` is missing from the Release Item",
      reference:
        "TODO: Add your company-specific documentation link for estimation conventions",
    },
    tooGranularEstimate: {
      label:
        "The `Story point estimate` effort is too small, should be at least 0,5 week",
      reference:
        "TODO: Add your company-specific documentation link for estimation guidelines",
    },
    missingStage: {
      label: "The stage is missing from the Release Item",
      reference:
        "TODO: Add your company-specific documentation link for stage requirements",
    },
    missingAssignee: {
      label: "The assignee is missing from the Release Item",
      reference:
        "TODO: Add your company-specific documentation link for assignment requirements",
    },
    tooLowStageWithoutProperRoadmapItem: {
      ...
      reference:
        "TODO: Add your company-specific documentation link for roadmap item requirements",
    },
  },
  roadmapItem: {
    missingAreaLabel: {
    ...
    missingAreaTranslation: (area: string) => ({
      ...
      reference:
        "TODO: Add your company-specific documentation link for area translations",
    }),
    missingThemeTranslation: (theme: string) => ({
      label: `The theme \`${theme}\` is not yet translated`,
      reference:
        "TODO: Add your company-specific documentation link for theme translations",
    }),
    missingInitiativeTranslation: (initiative: string) => ({
      label: `The initiative \`${initiative}\` is not yet translated`,
      reference:
        "TODO: Add your company-specific documentation link for initiative translations",
    }),
    missingExternalRoadmap: {
      ...
      reference:
        "TODO: Add your company-specific documentation link for external roadmap requirements",
    },
