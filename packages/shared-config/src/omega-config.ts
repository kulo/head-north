...
export default class OmegaConfig {
      ...
      common: {
        ...
        organisation: {
          ...
          teams: {
            ...
            "platform.data-engineering.operations":
              "DE Engineering Operations Support",
            "platform.data-engineering.data-science-support":
              "DE Data Science Support",
  ...
  getStageCategories(): {
    ...
    return (
      this.config.common.releaseStrategy.stageCategories || {
        finalReleaseStage: [],
        releasableStage: [],
        externalStages: [],
      }
  ...
  getEnvironmentConfig(): {
    ...
    return (
      this.config.common.environments[
        this.environment as keyof typeof this.config.common.environments
      ] || this.config.common.environments.development
    );
  }
  ...
  getItemStatusConfig(): {
    ...
    categories: { finished: string[]; active: string[]; future: string[] };
  } {
