<template>
  <div
    class="global-objectives__progress"
    :class="{ 'global-objectives__progress-gt4': objectives.length > 4 }"
  >
    <div class="global-objectives__progress__row">
      <div class="global-objectives__progress__big-container">
        <div class="global-objectives__progress__big">
          {{ cycle.progress }}%
        </div>
        <div class="global-objectives__progress__big-title">
          Overall Progress
        </div>
      </div>
      ...
      <div class="global-objectives__time__bar">
        <div class="global-objectives__time__start">
          {{ cycle.startMonth }}
        </div>
    ...
    <a-row :gutter="16" justify="start">
      <a-col :xs="8" :sm="4">
        <div class="global-objectives__progress__value-container">
          <div class="global-objectives__progress_value">
            {{ cycle.weeks }} wks
          </div>
      ...
      <a-col :xs="8" :sm="4">
        <div class="global-objectives__progress__value-container">
          <div class="global-objectives__progress_value">
            {{ cycle.cycleItemsDoneCount }} of {{ cycle.cycleItemsCount }}
          </div>
          <div class="global-objectives__progress__title">Cycle Items Done</div>
        </div>
      </a-col>
    </a-row>
  </div>
