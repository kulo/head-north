...
/**
 * Parse cycle data using existing parsers but return flat structure
 * This integrates Jira-specific parsing with our flat data approach
 */
export default async (omegaConfig, jiraApi) => {
