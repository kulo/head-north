...
export function isFinalReleaseStage(stage: string, omegaConfig: OmegaConfig): boolean {
  return omegaConfig.isFinalReleaseStage(stage);
}

export function isReleasableStage(stage: string, omegaConfig: OmegaConfig): boolean {
  return omegaConfig.isReleasableStage(stage);
}

export function isExternalStage(stage: string, omegaConfig: OmegaConfig): boolean {
 ...
 */
export function resolveStage(name: string = '', omegaConfig: OmegaConfig): string {
