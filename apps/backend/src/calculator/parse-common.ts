...
export function getLabelsWithPrefix(labels: string[], prefix: string): string[] {
...
export function translateLabel(labelType: string, value: string, omegaConfig: OmegaConfig): string {
...
export function translateLabelWithoutFallback(labelType: string, value: string, omegaConfig: OmegaConfig): string | undefined {
  const labelTranslations = omegaConfig.getLabelTranslations();
