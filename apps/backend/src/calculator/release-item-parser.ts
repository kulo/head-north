...
export class ReleaseItemParser {
  ...
  private _collectEffort(issue: JiraIssue): { value: number; validations: any[] } {
  ...
  private _collectProjectId(issue: JiraIssue): { value: string | null; validations: any[] } {
  ...
  private _collectAreaIds(issue: JiraIssue): { value: string[]; validations: any[] } {
  ...
  private _collectTeams(issue: JiraIssue): { value: string[]; validations: any[] } {
  ...
  private _collectStage(issue: JiraIssue): { value: string; validations: any[] } {
    const stage = resolveStage(issue.fields.summary, this.omegaConfig);
    return { value: stage, validations: [] };
  }

  private _collectAssignee(issue: JiraIssue): { value: any; validations: any[] } {
