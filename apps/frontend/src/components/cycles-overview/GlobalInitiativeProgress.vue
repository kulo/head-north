<template>
  <div class="global-initiatives__progress" :class="{ 'global-initiatives__progress-gt4': initiatives.length > 4}">
    <div class="global-initiatives__progress__row">
      <div class="global-initiatives__progress__big-container">
        <div class="global-initiatives__progress__big">{{ cycle.progress }}%</div>
        <div class="global-initiatives__progress__big-title">Overall Progress</div>
      </div>

      <div
        class="global-initiatives__progress__bar"
        :style="{'--percentage': cycle.progress + '%', '--percentage-with-in-progress': cycle.progressWithInProgress + '%', '--percentage-not-to-do': cycle.percentageNotToDo + '%'}"
      >
      ...
      <div class="global-initiatives__time__bar">
        <div class="global-initiatives__time__start">{{ cycle.startMonth }}</div>
    ...
    <a-row :gutter="16" justify="start">
      <a-col :xs="8" :sm="4">
        <div class="global-initiatives__progress__value-container">
          <div class="global-initiatives__progress_value">{{ cycle.weeks }} wks</div>
          <div class="global-initiatives__progress__title">Estimation</div>
        </div>
      </a-col>
      <a-col :xs="8" :sm="4">
        <div class="global-initiatives__progress__value-container">
          <div class="global-initiatives__progress_value">{{ cycle.weeksDone }} wks</div>
          <div class="global-initiatives__progress__title">Done</div>
        </div>
      </a-col>
      <a-col class="hidden-xs-only" :sm="4">
        <div class="global-initiatives__progress__value-container">
          <div class="global-initiatives__progress_value">{{ cycle.weeksInProgress }} wks</div>
          <div class="global-initiatives__progress__title">In Progress</div>
        </div>
      </a-col>
      <a-col class="hidden-xs-only" :sm="4">
        <div class="global-initiatives__progress__value-container">
          <div class="global-initiatives__progress_value">{{ cycle.weeksCancelled }} wks</div>
          <div class="global-initiatives__progress__title">Cancelled</div>
        </div>
      </a-col>
      <a-col class="hidden-xs-only" :sm="4">
        <div class="global-initiatives__progress__value-container">
          <div class="global-initiatives__progress_value">{{ cycle.weeksPostponed }} wks</div>
      ...
      <a-col :xs="8" :sm="4">
        <div class="global-initiatives__progress__value-container">
          <div
            class="global-initiatives__progress_value"
          >{{ cycle.releaseItemsDoneCount }} of {{ cycle.releaseItemsCount }}</div>
          <div class="global-initiatives__progress__title">Release Items Done</div>
        </div>
      </a-col>
    </a-row>
  </div>
